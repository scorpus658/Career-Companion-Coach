...
const S: Record<string, CSSProperties> = {
  main: { maxWidth: 1080, margin: "0 auto", padding: "44px 24px 80px", fontFamily: "var(--font-geist-sans), system-ui, sans-serif", color: "#111827" },
  header: { marginBottom: 28 },
  h1: { fontSize: 27, margin: 0, fontWeight: 700, letterSpacing: "-0.02em", color: "#0f172a" },
  sub: { color: "#475569", marginTop: 10, maxWidth: 640, lineHeight: 1.55, fontSize: 15 },
  cols: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, alignItems: "start" },
  col: { minWidth: 0, background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 16, padding: "22px 24px", boxShadow: "0 1px 2px rgba(16,24,40,0.04), 0 1px 3px rgba(16,24,40,0.06)" },
  ...
  primary: { background: "#4f46e5", color: "#fff", border: "none", borderRadius: 10, padding: "10px 18px", fontSize: 14, fontWeight: 600, cursor: "pointer" },
  secondary: { background: "#fff", color: "#374151", border: "1px solid #d1d5db", borderRadius: 10, padding: "10px 16px", fontSize: 14, fontWeight: 500, cursor: "pointer", marginBottom: 16 },
  danger: { background: "#dc2626", color: "#fff", border: "none", borderRadius: 10, padding: "10px 18px", fontSize: 14, fontWeight: 600, cursor: "pointer" },
  status: { color: "#6b7280", fontSize: 13 },
  checkboxRow: { display: "flex", alignItems: "flex-start", gap: 8, fontSize: 13, color: "#475569", marginBottom: 16, cursor: "pointer", maxWidth: 480, lineHeight: 1.45 },
  input: { flex: 1, border: "1px solid #d1d5db", borderRadius: 10, padding: "10px 12px", fontSize: 13, fontFamily: "inherit", color: "#111827", background: "#fff" },
  transcript: { border: "1px solid #e5e7eb", borderRadius: 12, padding: 14, minHeight: 160, maxHeight: 360, overflowY: "auto", background: "#f9fafb", marginBottom: 12 },
  asstLine: { margin: "8px 0", color: "#1f2937", lineHeight: 1.55, fontSize: 14 },
  userLine: { margin: "8px 0", color: "#4338ca", lineHeight: 1.55, fontSize: 14 },
  h3: { fontSize: 12, marginTop: 20, marginBottom: 10, fontWeight: 600, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em" },
  muted: { color: "#6b7280", fontSize: 14, lineHeight: 1.5 },
  warn: { background: "#fffbeb", border: "1px solid #fde68a", borderRadius: 10, padding: 12, fontSize: 13, width: "100%", color: "#92400e" },
  error: { background: "#fef2f2", border: "1px solid #fecaca", borderRadius: 10, padding: 12, fontSize: 13, color: "#b91c1c", marginBottom: 12 },
};
